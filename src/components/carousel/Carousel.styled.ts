...
const CarouselStyled = styled.default.div<CarouselStyledProps>`
    ...
    @media (min-width: 1024px) {
        padding-left: ${props => StyleUtils.calcOverrunXSpace(props.style.itemStyleConfig, props.display, CAROUSEL_STYLE_MEDIA_TYPE.DESKTOP) + 
                                 props.style.mediaTypes[CAROUSEL_STYLE_MEDIA_TYPE.DESKTOP].overrunExtraPaddingX}px;
        width: ${props => StyleUtils.calcXSpace(props.style.itemStyleConfig, props.display, CAROUSEL_STYLE_MEDIA_TYPE.DESKTOP)}px;
        height: ${props => StyleUtils.calcYSpace(props.style.itemStyleConfig, props.display, CAROUSEL_STYLE_MEDIA_TYPE.DESKTOP)}px;
    ...
    .grid-inner {
        ...
        border-radius: ${props => props.style.mediaTypes[CAROUSEL_STYLE_MEDIA_TYPE.SMALL].borderRadiusSizeActive}px;
        border: ${props => props.style.mediaTypes[CAROUSEL_STYLE_MEDIA_TYPE.SMALL].borderSizeActive}px solid ${props => props.style.theme.borderColorActive};
        margin-top: ${props => StyleUtils.calcOverrunYSpace(props.style.itemStyleConfig, props.display, CAROUSEL_STYLE_MEDIA_TYPE.SMALL) - 
                                                            props.style.mediaTypes[CAROUSEL_STYLE_MEDIA_TYPE.SMALL].activeExtraPaddingTop}px;
        margin-left: ${props => props.style.mediaTypes[CAROUSEL_STYLE_MEDIA_TYPE.SMALL].activeExtraPaddingX * -1}px;
        width: ${props => StyleUtils.calcActiveXSpace(props.style.itemStyleConfig, props.display, CAROUSEL_STYLE_MEDIA_TYPE.SMALL) + 
